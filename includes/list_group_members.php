...
<?php
$sql	= "SELECT id, group_name FROM ".$wpdb -> prefix."group_sets WHERE group_leader = '".$_GET["leader_id"]."'";
...
if(count($result) > 0):
	...
	$targetpage = 'admin.php?page=membermouseviewgroup&leader_id=';
	if(!empty($show)):
...
$noticeSql		= "SELECT * FROM ".$wpdb -> prefix."group_notices WHERE msg_type = '1' AND leader_id = '".$_GET["leader_id"]."' ORDER BY createdDate DESC";
